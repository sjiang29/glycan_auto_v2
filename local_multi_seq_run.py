...
def main(argv):
        ...
        if len(argv) != 5:
            ...
            print("Example usage: python local_multi_run.py 10 1 2 100 antigens.csv")
            sys.exit(2)
        else:
            ...
            n_struct = int(sys.argv[4])
            antigens_csv = sys.argv[5]
            ...
            with open(antigens_csv, mode ='r') as file:    
                ...
                for lines in csvFile:
                    ...
                    for i in range(start_pos, end_pos + 1):  # Change to add more tasks if needed
